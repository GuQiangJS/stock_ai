...
def test_train():
    ...
    history = model.fit(train_x,
                        ...
                        verbose=0,
                        # callbacks=[EarlyStopping(monitor='mse')]
                        )
...
#     return {
#         'need_is_sus':
#         calcs.is_trade_suspension,
#         # # 'year':
#         # # calcs.calc_year,
#         # # 'month':
#         # # calcs.calc_month,
#         # # 'need_year_onehot': [calcs.trans_onehot, {
#         # #     'column': 'year'
#         # # }],
#         # # 'need_month_onehot': [calcs.trans_onehot, {
#         # #     'column': 'month'
#         # # }],
#         # # 'sum_return_close': [calcs.calc_cum_return, {
#         # #     'column': 'close'
#         # # }],
#         # 'macd_5_15_10':[QA_indicator_MACD,{'short':5, 'long':15, 'mid':10}],#macd
#         # 'mtm_10_5_need_':[QA_indicator_MTM,{'N':10, 'M':5}],#动量线
#         # 'mtm_15_10_need_':[QA_indicator_MTM,{'N':15, 'M':10}],#动量线
...
#         # 'bbands_5_2_2':
#         # calcs.tech_bbands,
#         # 'bbands_10_2_2': [calcs.tech_bbands, {
#         #     'timeperiod': 10
#         # }],
#         # 'bbands_15_2_2': [calcs.tech_bbands, {
#         #     'timeperiod': 15
#         # }],
#         'need_': [
#             calcs.calc_daily_return, {
#                 'columns': [
#         #             'ema_5', 'ema_10', 'ema_15',
#                                 'close', 'volume',
#         #             'close399300', 'volume399300', 'close601939',
#         #             'volume601939', 'close601328', 'volume601328',
#         #             'close600036', 'volume600036', 'close601988',
#         #             'volume601988', 'close601288', 'volume601288',
#         #             'BOLL_bbands_5_2_2', 'UB_bbands_5_2_2', 'LB_bbands_5_2_2',
#         #             'BOLL_bbands_10_2_2', 'UB_bbands_10_2_2',
#         #             'LB_bbands_10_2_2', 'BOLL_bbands_15_2_2',
#         #             'UB_bbands_15_2_2', 'LB_bbands_15_2_2'
#                 ]
#             }
#         ],
#         'fillna': [calcs.fillna, {
#             'replace': True,'method':'ffill'
#         }],
#         'dropna': [calcs.dropna, {
#             'replace': True
#         }]
...
#         print('{0}:min:{1},max:{2},dtype:{3}.'.format(col,df[col].min(),df[col].max(),df[col].dtypes))
#     return [col for col in df.columns if 'need_' in col], ['close_need_']
